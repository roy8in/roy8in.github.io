...
<p align="center">
  <img src="https://github.com/roy8in/roy8in.github.io/blob/main/images/posts/pca/pca-figure1.png?raw=true" width="75%"/>
</p>
...
<p align="center">
  <img src="https://github.com/roy8in/roy8in.github.io/blob/main/images/posts/pca/pca-figure2.png?raw=true" width="75%"/>
</p>
...
즉, 행렬 $C_1$이 만드는 변형은, 공간이 우상(↗)/좌하(↙)로는 늘어나고, 좌상(↖)/우하(↘)로는 수축된다. 마치, 오른쪽 상단과 왼쪽 하단을 양손으로 잡고 길게 늘리는 모양이다.

<p align="center">
  <img src="https://github.com/roy8in/roy8in.github.io/blob/main/images/posts/pca/pca-figure3.png?raw=true" width="75%"/>
</p>
...
즉, 공간이 좌상(↖)/우하(↘)로는 늘어나고, 우상(↗)/좌하(↙)로는 수축된다. 마치, 왼쪽 상단과 오른쪽 하단을 양손으로 잡고 길게 늘리는 모양이다.

<p align="center">
  <img src="https://github.com/roy8in/roy8in.github.io/blob/main/images/posts/pca/pca-figure4.png?raw=true" width="75%"/>
</p>
...
<p align="center">
  <img src="https://github.com/roy8in/roy8in.github.io/blob/main/images/posts/pca/pca-figure5.png?raw=true" width="75%"/>
</p>
...
<p align="center">
  <img src="https://github.com/roy8in/roy8in.github.io/blob/main/images/posts/pca/pca-figure6.png?raw=true" width="75%"/>
</p>
...
위 예에서 $X$와 $Y$는 행렬 $C_1$을 상관관계 행렬로 갖는 두 데이터이다. 즉, **$X$와 $Y$는 2차원 공간의 임의의 점들이 두 고유벡터 방향으로 고유값배 만큼 늘려진 공간에서 추출된 데이터**라고도 이해할 수 있다. 상관관계 만큼 관련이 있는 것이다.
